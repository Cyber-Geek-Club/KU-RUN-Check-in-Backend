...
async def migrate_daily_checkin():
    ...
    # We use engine.connect() instead of engine.begin() to control transaction manually
    # This allows us to query information_schema safely before altering
    async with engine.connect() as conn:
        ...
        try:
            ...
            if not enum_name:
                ...
                # Use the detected name to alter the type
